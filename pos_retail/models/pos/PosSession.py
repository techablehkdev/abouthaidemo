...
class PosSession(models.Model):
    ...
    def action_pos_session_closing_control(self, balancing_account=False, amount_to_balance=0):
        ...
        res = super(PosSession, self).action_pos_session_closing_control(balancing_account=balancing_account,
    ...
    def get_session_online(self):
        return {
            ...
            'module_installed': True if self.env['ir.module.module'].sudo().search([('name', '=', 'pos_retail')], limit=1) else False
        }
